...
function dateToTimestamp(date) {
  ...
  date1.toLocaleTimeString('en-US', { hour12: false });
...
function getTime(date) {
  const date1 = new Date(date);
  return date1.toLocaleTimeString('it-IT', { hour12: false });
}
...
function getNextFriday(date) {
  ...
  switch (date1.getDay()) {
    case 0:
      days = date1.setDate(date1.getDate() + 5);
      break;
    case 1:
      days = date1.setDate(date1.getDate() + 4);
      break;
    case 2:
      days = date1.setDate(date1.getDate() + 3);
      break;
    case 3:
      days = date1.setDate(date1.getDate() + 2);
      break;
    case 4:
      days = date1.setDate(date1.getDate() + 1);
      break;
    case 5:
      days = date1.setDate(date1.getDate() + 7);
      break;
    case 6:
      days = date1.setDate(date1.getDate() + 6);
      break;
    default:
      break;
  }
...
function getCountWeekendsInMonth(month, year) {
  ...
  let count = 0;
  for (let i = 1; i <= dates2; i += 1) {
    const days3 = new Date(dates.getFullYear(), dates.getMonth(), i).getDay();
    if (days3 === 6 || days3 === 0) {
      count += 1;
    }
  }
